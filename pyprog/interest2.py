...
print
print "I know the answer but you'll have to guess my favourite number."
print
guess1 = input("What do you think it is?: ")
if guess1 == 7:
	print "I lied, I don't know the answer but here's my best attempt:",total,"Euro"
else:
	print "Strike one"
guess2 = input("What do you think it is?: ")
if guess2 == 7:
	print "I lied, I don't know the answer but here's my best attempt:",total,"Euro"
else:
	print "Strike two"
guess3 = input("What do you think it is?: ")
if guess3 == 7:
	print "I lied, I don't know the answer but here's my best attempt:",total,"Euro"
else:
	print "STRIKEOUT"
